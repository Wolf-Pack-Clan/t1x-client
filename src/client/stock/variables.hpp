...
namespace game
{
	...
	WEAK symbol<float> ads_progress{ 0x30207214, BASE_CGAME_MP }; // Between 0 and 1
	WEAK symbol<float> fov_visible{ 0x3020958c, BASE_CGAME_MP }; // Not the cg_fov cvar value
	WEAK symbol<float> cg_fov_value{ 0x30298c68, BASE_CGAME_MP };
	WEAK symbol<pmove_t*> pm{ 0x3019d570, BASE_CGAME_MP };
	WEAK symbol<weaponInfo_t[MAX_WEAPONS]> cg_weapons{ 0x300eef3c, BASE_CGAME_MP };
